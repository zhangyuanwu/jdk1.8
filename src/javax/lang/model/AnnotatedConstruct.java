 ...
 *
 * The terms <em>directly present</em>, <em>present</em>, <em>indirectly
 * present</em>, and <em>associated </em> are used throughout this interface to
 * describe precisely which annotations are returned by the methods defined
 * herein.
 *
 * <p>
...
public interface AnnotatedConstruct {
	 ...
	 * that this method detects if its argument is a <em>repeatable annotation
	 * type</em>, and if so, attempts to find one or more annotations of that

 ...
 * validated with <a href="http://www.phy.duke.edu/~rgb/General/dieharder.php">
 * version 3.31.1</a>.) These tests validate only the methods for certain types
 * and ranges, but similar properties are expected to hold, at least
 * approximately, for others as well. The <em>period</em> (length of any series
 * of generated values before it repeats) is at least 2<sup>64</sup>.</li>
 *

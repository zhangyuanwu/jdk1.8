...
public final class Locale implements Cloneable, Serializable {
	 ...
	 * extensions</a>. If this {@code Locale} has no extensions, this
	 * {@code Locale} is returned.
	 *
	 ...
	 * second and subsequent names in parentheses. For example: <blockquote>
	 ...
	 *                  String language subtag in lower case. (See <a href=
	 *                  "java/util/Locale.html#getLanguage()">getLanguage()</a>)
	 * @serialField country
	 *                  String country subtag in upper case. (See <a href=
	 *                  "java/util/Locale.html#getCountry()">getCountry()</a>)
	 * @serialField variant
	 *                  String variant subtags separated by LOWLINE characters.
	 *                  (See <a href=
	 *                  "java/util/Locale.html#getVariant()">getVariant()</a>)
	 * @serialField hashcode
	 *                  int deprecated, for forward compatibility only
	 * @serialField script
	 *                  String script subtag in title case (See <a href=
	 *                  "java/util/Locale.html#getScript()">getScript()</a>)
	 ...
	 *                  by HYPHEN-MINUS characters. (See <a href=
	 *                  "java/util/Locale.html#getExtensionKeys()">getExtensionKeys()</a>,
	 *                  <a href=
	 *                  "java/util/Locale.html#getExtension(char)">getExtension(char)</a>)
	 */

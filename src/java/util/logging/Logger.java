...
public class Logger {
	...
	private void setCallersClassLoaderRef(Class<?> caller) {
		...
		if (callersClassLoader != null) {
			callersClassLoaderRef = new WeakReference<>(callersClassLoader);
		}
	}
	...
	private LoggerBundle getEffectiveLoggerBundle() {
		...
		while (target != null) {
			...
			final String rbName = isSystemLogger ? (target.isSystemLogger ? trb.resourceBundleName : null) : target.getResourceBundleName();
			if (rbName != null) {

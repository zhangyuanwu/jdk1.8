...
public class Vector<E> extends AbstractList<E> implements List<E>, RandomAccess, Cloneable, java.io.Serializable {
	 ...
	 *             incompatible with the specified collection (<a href=
	 *             "Collection.html#optional-restrictions">optional</a>)
	 * @throws NullPointerException
	 *             if this vector contains one or more null elements and the
	 *             specified collection does not support null elements (<a href=
	 ...
	 *             if the stream contains data of a non-existing class
	 */
	...
	static final class VectorSpliterator<E> implements Spliterator<E> {
		...
		public Spliterator<E> trySplit() {
			...
			return (lo >= mid) ? null : new VectorSpliterator<>(list, array, lo, index = mid, expectedModCount);
		}

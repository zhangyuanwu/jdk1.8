...
public final class Spliterators {
	 ...
	 * data is considered to have an an encounter order, specify
	 * {@code ORDERED}). The method {@link Arrays#spliterator(long[], int, int)}
	 * can often be used instead, which returns a spliterator that reports
	...
	public static abstract class AbstractIntSpliterator implements Spliterator.OfInt {
		...
		protected AbstractIntSpliterator(long est, int additionalCharacteristics) {
			this.est = est;
			characteristics = ((additionalCharacteristics & Spliterator.SIZED) != 0) ? additionalCharacteristics | Spliterator.SUBSIZED : additionalCharacteristics;
		}

...
public abstract class ResourceBundle {
	...
	private static class RBClassLoader extends ClassLoader {
		private static final RBClassLoader INSTANCE = AccessController.doPrivileged((PrivilegedAction<RBClassLoader>) () -> new RBClassLoader());
	 ...
	 * <a name="candidates"><em>candidate bundle names</em></a>. If the
	 * specified locale's language, script, country, and variant are all empty
	 * strings, then the base name is the only candidate bundle name. Otherwise,
	 * a list of candidate locales is generated from the attribute values of the
	 ...
	 *
	 * <table style="width: 50%; text-align: left; margin-left: 40px;" border=
	 * "0" cellpadding="2" cellspacing="2" summary="locale-format combinations
	 * for newBundle">
	 * <tbody>
	 * <tr>
	 * <td style="vertical-align: top; text-align: left; font-weight: bold;
	 * width: 50%;"><code>Locale</code><br>
	 * </td>
	 * <td style="vertical-align: top; text-align: left; font-weight: bold;
	 * width: 50%;"><code>format</code><br>
	 * </td>
	 * </tr>
	 * <tr>
	 * <td style="vertical-align: top; width:
	 * 50%;"><code>Locale("de", "DE")</code><br>
	 * </td>
	 ...
	 * <tr>
	 * <td style="vertical-align: top; width:
	 * 50%;"><code>Locale("de", "DE")</code></td>
	 * <td style="vertical-align: top; width:
	 * 50%;"><code>java.properties</code><br>
	 * </td>
	 * </tr>
	 * <tr>
	 * <td style="vertical-align: top; width:
	 * 50%;"><code>Locale("de")</code></td>
	 ...
	 * 50%;"><code>Locale("de")</code></td>
	 * <td style="vertical-align: top; width:
	 * 50%;"><code>java.properties</code></td>
	 * </tr>
	 * <tr>
	...
	public static class Control {
		 ...
		 * {@link #toBundleName(String, Locale) toBundleName(baseName,
		 * locale)}.</li>
		 *
		 ...
		 * {@link #TTL_NO_EXPIRATION_CONTROL}.
		 *
		 * @param baseName

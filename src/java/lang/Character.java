...
public final class Character implements Serializable, Comparable<Character> {
	 ...
	 * three special values, {@link Character.UnicodeScript#INHERITED
	 * Inherited}, {@link Character.UnicodeScript#COMMON Common} or
	 ...
	 * {@code true}, then {@link #isHighSurrogate
	 * isHighSurrogate}{@code (highSurrogate(x))} and {@link #toCodePoint
	 * toCodePoint}{@code (highSurrogate(x), }{@link #lowSurrogate
	 ...
	 * <p>
	 * If {@link #isSupplementaryCodePoint isSupplementaryCodePoint(x)} is
	 * {@code true}, then {@link #isLowSurrogate
	 * isLowSurrogate}{@code (lowSurrogate(x))} and {@link #toCodePoint
	 * toCodePoint}{@code (}{@link #highSurrogate
	 * highSurrogate}{@code (x), lowSurrogate(x)) == x} are also always
	 * {@code true}.
	 *
	 * @param codePoint
	 *            a supplementary character (Unicode code point)
	 ...
	 *
	 * <p>
	 * <b>Note:</b> This method cannot handle <a href="#supplementary">
	 * supplementary characters</a>. To support all Unicode characters,
	 * including supplementary characters, use the {@link #isLowerCase(int)}
	 * method.
	 *
	 * @param ch
	 ...
	 * <p>
	 * A character is lowercase if its general category type, provided by
	 * {@link Character#getType getType(codePoint)}, is
	 * {@code LOWERCASE_LETTER}, or it has contributory property Other_Lowercase
	 ...
	 * <b>Note:</b> This method cannot handle <a href="#supplementary">
	 * supplementary characters</a>. To support all Unicode characters,
	 * including supplementary characters, use the {@link #isUpperCase(int)}
	 * method.
	 *
	 * @param ch
	 *            the character to be tested.
	 ...
	 * <b>Note:</b> This method cannot handle <a href="#supplementary">
	 * supplementary characters</a>. To support all Unicode characters,
	 * including supplementary characters, use the {@link #isTitleCase(int)}
	 * method.
	 *
	 * @param ch
	 *            the character to be tested.
	 ...
	 * <b>Note:</b> This method cannot handle <a href="#supplementary">
	 * supplementary characters</a>. To support all Unicode characters,
	 * including supplementary characters, use the {@link #isDigit(int)} method.
	 *
	 * @param ch
	 *            the character to be tested.
	 ...
	 * <b>Note:</b> This method cannot handle <a href="#supplementary">
	 * supplementary characters</a>. To support all Unicode characters,
	 * including supplementary characters, use the {@link #isDefined(int)}
	 * method.
	 *
	 * @param ch
	 *            the character to be tested
	 ...
	 * <b>Note:</b> This method cannot handle <a href="#supplementary">
	 * supplementary characters</a>. To support all Unicode characters,
	 * including supplementary characters, use the {@link #isLetter(int)}
	 * method.
	 *
	 * @param ch
	 *            the character to be tested.
	 ...
	 * <b>Note:</b> This method cannot handle <a href="#supplementary">
	 * supplementary characters</a>. To support all Unicode characters,
	 * including supplementary characters, use the {@link #isLetterOrDigit(int)}
	 * method.
	 *
	 * @param ch
	 *            the character to be tested.
	 ...
	 * <li>{@code ch} is a connecting punctuation character (such as
	 * {@code '_'}).
	 * </ul>
	 *
	 * @param ch
	 ...
	 * <b>Note:</b> This method cannot handle <a href="#supplementary">
	 * supplementary characters</a>. To support all Unicode characters,
	 * including supplementary characters, use the {@link #toLowerCase(int)}
	 * method.
	 *
	 * @param ch
	 ...
	 * <b>Note:</b> This method cannot handle <a href="#supplementary">
	 * supplementary characters</a>. To support all Unicode characters,
	 * including supplementary characters, use the {@link #toUpperCase(int)}
	 * method.
	 *
	 * @param ch
	 *            the character to be converted.
	 ...
	 * <b>Note:</b> This method cannot handle <a href="#supplementary">
	 * supplementary characters</a>. To support all Unicode characters,
	 * including supplementary characters, use the {@link #toTitleCase(int)}
	 * method.
	 *
	 * @param ch
	 *            the character to be converted.
	 ...
	 * <b>Note:</b> This method cannot handle <a href="#supplementary">
	 * supplementary characters</a>. To support all Unicode characters,
	 * including supplementary characters, use the {@link #digit(int, int)}
	 * method.
	 *
	 * @param ch
	 *            the character to be converted.
	 ...
	 * <b>Note:</b> This method cannot handle <a href="#supplementary">
	 * supplementary characters</a>. To support all Unicode characters,
	 * including supplementary characters, use the {@link #getNumericValue(int)}
	 * method.
	 *
	 * @param ch
	 *            the character to be converted.
	 ...
	 * <b>Note:</b> This method cannot handle <a href="#supplementary">
	 * supplementary characters</a>. To support all Unicode characters,
	 * including supplementary characters, use the {@link #isSpaceChar(int)}
	 * method.
	 *
	 * @param ch
	 *            the character to be tested.
	 ...
	 * <b>Note:</b> This method cannot handle <a href="#supplementary">
	 * supplementary characters</a>. To support all Unicode characters,
	 * including supplementary characters, use the {@link #isWhitespace(int)}
	 * method.
	 *
	 * @param ch
	 *            the character to be tested.
	 ...
	 * <b>Note:</b> This method cannot handle <a href="#supplementary">
	 * supplementary characters</a>. To support all Unicode characters,
	 * including supplementary characters, use the {@link #isISOControl(int)}
	 * method.
	 *
	 * @param ch
	 *            the character to be tested.
	 ...
	 * <b>Note:</b> This method cannot handle <a href="#supplementary">
	 * supplementary characters</a>. To support all Unicode characters,
	 * including supplementary characters, use the {@link #getType(int)} method.
	 *
	 * @param ch
	 *            the character to be tested.

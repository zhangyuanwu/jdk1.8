...
public final class Short extends Number implements Comparable<Short> {
	 ...
	 * ({@code '\u005Cu002D'}) to indicate a negative value or an ASCII plus
	 * sign {@code '+'} ({@code '\u005Cu002B'}) to indicate a positive value.
	 * The resulting {@code short} value is returned, exactly as if the argument
	 ...
	 *         {@code Short} is numerically less than the argument
	 *         {@code Short}; and a value greater than {@code 0} if this
	 *         {@code Short} is numerically greater than the argument
	 *         {@code Short} (signed comparison).
	 * @since 1.2
	 */
	@Override

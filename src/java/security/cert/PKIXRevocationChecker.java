...
public abstract class PKIXRevocationChecker extends PKIXCertPathChecker {
	...
	public void setOcspExtensions(List<Extension> extensions) {
		ocspExtensions = (extensions == null) ? Collections.<Extension>emptyList() : new ArrayList<>(extensions);
	}
	...
	public void setOcspResponses(Map<X509Certificate, byte[]> responses) {
		if (responses == null) {
			ocspResponses = Collections.<X509Certificate, byte[]>emptyMap();
		} else {
	...
	public void setOptions(Set<Option> options) {
		this.options = (options == null) ? Collections.<Option>emptySet() : new HashSet<>(options);
	}

...
public final class Files {
	 ...
	 *             {@link LinkPermission}<tt>("symbolic")</tt> or its
	 ...
	 *             In the case of the default provider, and a security manager
	 *             is installed, it denies
	 *             {@link LinkPermission}<tt>("hard")</tt> or its
	 *             {@link SecurityManager#checkWrite(String) checkWrite} method
	 ...
	 * <li>It is <i>symmetric</i>: for two {@code Paths} {@code f} and
	 * {@code g}, {@code isSameFile(f,g)} will equal {@code isSameFile(g,f)}.
	 * <li>It is <i>transitive</i>: for three {@code Paths} {@code f},
	 * {@code g}, and {@code h}, if {@code isSameFile(f,g)} returns {@code true}
	 * and {@code isSameFile(g,h)} returns {@code true}, then
	...
	private static class FileTypeDetectors {
		...
		private static FileTypeDetector createDefaultFileTypeDetector() {
			return AccessController.doPrivileged((PrivilegedAction<FileTypeDetector>) () -> sun.nio.fs.DefaultFileTypeDetector.create());
		}

		// loads all installed file type detectors
		private static List<FileTypeDetector> loadInstalledDetectors() {
			return AccessController.doPrivileged((PrivilegedAction<List<FileTypeDetector>>) () -> {
	 ...
	 * takes the form: <blockquote>
	 * [<i>view-name</i><b>:</b>]<i>attribute-name</i> </blockquote> where
	 * square brackets [...] delineate an optional component and the character
	 ...
	 * takes the form: <blockquote>
	 * [<i>view-name</i><b>:</b>]<i>attribute-list</i> </blockquote> where
	 * square brackets [...] delineate an optional component and the character
	 * {@code ':'} stands for itself.
	 *
	 * <p>
	 ...
	 *             or its {@link SecurityManager#checkRead(String) checkRead}
	 ...
	 * disposal of file system resources is required, the
